...
public:
    ...
    virtual te::SampleMark getSelectResultFormSampleMarkTable(const int& index, const std::string& keyword) = 0;
    ...
    virtual bool clearAllTestSampleMark() = 0;
    ...
    virtual bool clearAllThumbnail() = 0;
    virtual void setCurrentLoadImageNum(const int& num) = 0;
